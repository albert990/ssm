...
@Transactional
public class GoodsControllerTest extends AbstractContextControllerTests {
    private MockMvc mockMvc;
    private String listUrl = "/goods/list";
    private String detailUrl = "/goods/{goodsId}/buy";
    private String appointUrl = "/goods/{goodsId}/appoint";
    ...
    public void notExistDetail() throws Exception {
        this.mockMvc.perform(get(detailUrl, 1100)).andExpect(forwardedUrl("/goods/list"));
    }
